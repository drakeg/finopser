...
urlpatterns = [
    ...
    path("account-vending/requests/<int:pk>/executions/", vending_api.provisioning_executions, name="account-vending-executions"),
    ...
    path("notification-channels/", notification_channel_api.channels, name="notification-channels"),
    path("notification-channels/<int:pk>/", notification_channel_api.channel_detail, name="notification-channel-detail"),
    path("notification-channels/<int:pk>/disable/", notification_channel_api.disable_channel, name="notification-channel-disable"),
    path("notification-channels/<int:pk>/enable/", notification_channel_api.enable_channel, name="notification-channel-enable"),
    path("notification-channels/<int:pk>/deliveries/", notification_channel_api.channel_deliveries, name="notification-channel-deliveries"),
    path("notification-channels/<int:pk>/test/", notification_channel_api.test_channel, name="notification-channel-test"),
